...
// The JavaScript at the bottom calls /api/status once a second and fills
// in the table. Edit the HTML freely; to the ESP32 it is just text.
...
log('page loaded');
poll();setInterval(poll,1000);setInterval(tick,200);
